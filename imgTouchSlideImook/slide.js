var total = 17;
	...
	var render = function(){
		...
		for(var i=1;i<=total;i++){
			...
			tmpl+='<li data-id="'+i+'" class="animated bounceIn" style="width:'+picWidth+'px;height:'+picWidth+'px;padding-left:'+p+'px;padding-top:'+padding+'px;"><img src="static/imgs/'+i+'.jpg"></li>';
		}
		$('#container').html(tmpl);
	}
	render();
	...
	var loadImg = function(id,callback){
		...
		var imgsrc = 'static/imgs/'+id+'.large.jpg';
